<?php
//Include Common Files @1-A84D27FD
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "asistenciaalumn_list.php");
...
//Operation Method @2-0C476EE8
    function Operation()
    {
        ...
        $Redirect = "asistenciaalumn_list.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "asistenciaalumn_list.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "asistenciaalumn_list.html";
$BlockToParse = "main";
...
//Include events file @1-141248E3
include_once("./asistenciaalumn_list_events.php");
