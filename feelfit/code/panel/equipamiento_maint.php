<?php
//Include Common Files @1-C4343C1F
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "equipamiento_maint.php");
...
class clsRecordequipamiento { //equipamiento Class @2-B3A44BDE
...
//Class_Initialize Event @2-5F6B8E0A
    function clsRecordequipamiento($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record equipamiento/Error";
...
//Operation Method @2-2B8DA140
    function Operation()
    {
        ...
        $Redirect = "equipamiento_list.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
//DataSource Variables @2-256E7EE6
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-EB497A32
...
//Insert Method @2-F8E76DB9
    function Insert()
    {
        ...
        $this->SQL = CCBuildInsert("equipamiento", $this->InsertFields, $this);
...
//Update Method @2-9448E2FF
    function Update()
    {
        ...
        $this->SQL = CCBuildUpdate("equipamiento", $this->UpdateFields, $this);
...
//Delete Method @2-A7032672
    function Delete()
    {
        ...
        $this->SQL = "DELETE FROM equipamiento";
...
//Include Page implementation @9-8EACA429
include_once(RelativePath . "/header.php");
//End Include Page implementation

//Initialize Page @1-A928F84B
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "equipamiento_maint.html";
$BlockToParse = "main";
...
// Controls
$equipamiento = & new clsRecordequipamiento("", $MainPage);
...
//Execute Components @1-920878ED
$equipamiento->Operation();
$header->Operations();
