...
//Connection Settings @0-9294C3F5
$CCConnectionSettings = array (
    "Connection1" => array(
        "Type" => "MySQL",
        "DBLib" => "MySQL",
        "Database" => "feelfit_gimnasio",
        "Host" => "localhost",
        "Port" => "3306",
        "User" => "feelfit_ugim",
        "Password" => "dunkel*123",
...
//Initialize Common Variables @0-2B6506DA
...
//Connection2 Connection Class @-546913C1
class clsDBConnection2 extends DB_Adapter
{
    function clsDBConnection2()
    {
        $this->Initialize();
    }
    ...
    {
        global $CCConnectionSettings;
        $this->SetProvider($CCConnectionSettings["Connection2"]);
        parent::Initialize();
        $this->DateLeftDelimiter = "'";
        $this->DateRightDelimiter = "'";
    }
...
//End Connection2 Connection Class
